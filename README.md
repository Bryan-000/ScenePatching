...
### -- IMPORTANT --
It's super important to call this line anywhere in your mod <b>ONCE</b> before loading the game.\
`SceneModding.PatchAll()`\
so your patches actually work :3

### Making a ScenePatch
Make a new <b>static class/method</b> and add the `[ScenePatch]` attribute to it\
